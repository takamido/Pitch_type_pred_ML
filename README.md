...
├── program ── analysis1_logis.ipynb &nbsp;&nbsp;&nbsp; # Program codes for the main analysis (Analysis1)  
├── program ── analysis2.ipynb &nbsp;&nbsp;&nbsp; # Program codes for the main analysis (Analysis2)  
├── program ── analysis1_gru.ipynb, analysis1_lstm.ipynb, analysis1_va_dataset.ipynb &nbsp;&nbsp;&nbsp; # Program codes for the additional analysis (Analysis1)  
├── results &nbsp;&nbsp;&nbsp; # The results of the proposed analysis  

pitching_motion_videos &nbsp;&nbsp;&nbsp; # The video of each pitcher's motion (red: fastball, blue: breaking-ball)

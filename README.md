...
├── program ── analysis1_logis &nbsp;&nbsp;&nbsp; # Program codes for the main analysis (Analysis1)
├── program ── analysis2 &nbsp;&nbsp;&nbsp; # Program codes for the main analysis (Analysis2)
├── program ── analysis1_gru, analysis1_lstm, analysis1_va_dataset &nbsp;&nbsp;&nbsp; # Program codes for the additional analysis (Analysis1)
